  ...
  handleClick(destination) {
    return () => {
      ...
      if (
        ...
        `/users/${this.props.match.params.username}/${destination}`
      )
        return;
      ...
      <div style={topBarStyle}>
        <div>
          <div style={listContainer}>
            <div onClick={this.handleClick('')} style={userContainer}>
              {this.props.channelUser && (
                <div style={imageElement}>
                  {this.props.channelUser.picture && (
                    <img
            ...
            <div onClick={this.handleClick('')} style={usernameElement}>
